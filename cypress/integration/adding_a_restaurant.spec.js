describe('adding a restaurant', () => {
  ...
  function modalCanBeCanceled() {
    ...
    cy.get('[data-testid="cancelModalButton"]').click();
    cy.get('[data-testid="newRestaurantName"]').should('not.be.visible');
  }
  ...
  function modalDisplaysValidationErrors() {
    ...
    cy.get('label[for="restaurantName"][data-error="Cannot be blank"]').should('be.visible');
    cy.get('[data-testid="cancelModalButton"]').click();
  }
  ...
  function modalClearsOutValidationErrorWhenClosed() {
    ...
    cy.get('[data-testid="cancelModalButton"]').click();
    cy.get('[data-testid="addRestaurantButton"]').click();
    cy.get('label[for="restaurantName"][data-error="Cannot be blank"]').should('not.be.visible');
    cy.get('[data-testid="cancelModalButton"]').click();
  }
